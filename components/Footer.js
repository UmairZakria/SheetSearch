      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-4 text-xs text-slate-500 sm:flex-row">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-slate-700">SheetSearch</span>
            <span>·</span>
        ...
        <div className="mt-4 border-t border-slate-100 pt-4 text-center text-[11px] text-slate-400 sm:text-left">
          <p>
            ...
            ). All rights reserved. SheetSearch is not affiliated with or endorsed by Google LLC. Google Sheets and Google Drive are trademarks of Google LLC.
          </p>
        </div>
      </div>
    </footer>
