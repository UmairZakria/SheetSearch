...
const CustomScrollbar = () => {
  ...
  const handleThumbMouseDown = useCallback((e) => {
    ...
    const handleMouseMove = (e) => {
      ...
      const scrollProgress = maxThumbMoveRef.current > 0 ? clampedThumbTop / maxThumbMoveRef.current : 0;
  ...
  return (
    ...
    >
      <div
        ref={thumbRef}
        className="w-full bg-[#2C7EBA] rounded-full absolute top-0 cursor-pointer"
